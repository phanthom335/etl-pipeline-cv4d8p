        ...
        Etl Pipeline Cv4d8p
        ===================
        Developer-friendly pipeline tool built to migrate data at every processing stage.
...
def _write_output(rows: list, path: Path, suffix: str) -> None:
    ...
    if suffix == ".csv" and rows:
        ...
        def build_parser() -> argparse.ArgumentParser:
            p = argparse.ArgumentParser(prog=APP_NAME, description="Developer-friendly pipeline tool built to migrate data at every processing stage.")
